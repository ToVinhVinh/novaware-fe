...
export const FILTER_REMOVE_GENDER = 'FILTER_REMOVE_GENDER';
export const FILTER_SET_USAGE = 'FILTER_SET_USAGE';
export const FILTER_REMOVE_USAGE = 'FILTER_REMOVE_USAGE';
